...
I started this project as 1) Python libraries I've found were rudimentary at best, 2) Numpy, of course, is perfect, but is not east to use in this scenario.

Most of the code was taken from old (15 years+!) pet project https://github.com/mnvl/scratch, the bindings and the documentation is mostly generated by Claude with my curation.
